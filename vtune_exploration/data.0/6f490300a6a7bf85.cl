...
// Kernel name: reorder_weights_opt_265_weight_0_0
#define KERNEL(name) __kernel void reorder_weights_opt_265_weight_0_0
#define KERNEL_ID reorder_weights_opt_265_weight_0_0
#define FUNC(name)  _##name##_reorder_weights_opt_265_weight_0_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_265_weight_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_265_weight_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_265_weight_0_0
...
#define INPUT0_SIZES_DATA { 1,1,256,128,1,1,1,1,1, } 
...
#define OUTPUT_SIZES_DATA { 1,1,256,128,1,1,1,1,1, } 
...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_267_weight_0_0
#define KERNEL(name) __kernel void reorder_weights_opt_267_weight_0_0
#define KERNEL_ID reorder_weights_opt_267_weight_0_0
#define FUNC(name)  _##name##_reorder_weights_opt_267_weight_0_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_267_weight_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_267_weight_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_267_weight_0_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
...
#define INPUT0_OFM_PITCH 576
#define INPUT0_GROUPS_PITCH 1
#define INPUT0_LENGTH 36864
#define INPUT0_VIEW_OFFSET 0
#define INPUT0_DIMS 4
#define INPUT0_SIMPLE 1
#define INPUT0_GROUPED 0
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 3,3,64,64,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
#define INPUT0_PITCHES (size_t []){ 1,3,9,576,1,1,1,1,1, } 
#define INPUT0_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define INPUT0_PAD_AFTER (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define INPUT0_INDEX_FUNC inline uint FUNC(OIYX)(){return 0;}
#define INIT_INPUT0_INDEX_FUNC_HERE INPUT0_INDEX_FUNC
...
#define OUTPUT_OFM_PITCH 576
#define OUTPUT_GROUPS_PITCH 1
#define OUTPUT_LENGTH 36864
#define OUTPUT_VIEW_OFFSET 0
#define OUTPUT_DIMS 4
#define OUTPUT_SIMPLE 0
#define OUTPUT_GROUPED 0
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 3,3,64,64,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,3,9,576,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define OUTPUT_PAD_AFTER (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define OUTPUT_INDEX_FUNC inline uint FUNC(OS_IS_YX_ISV16_OSV16)(){return 0;}
#define INIT_OUTPUT_INDEX_FUNC_HERE OUTPUT_INDEX_FUNC
...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_268_weight_0_0
#define KERNEL(name) __kernel void reorder_weights_opt_268_weight_0_0
#define KERNEL_ID reorder_weights_opt_268_weight_0_0
#define FUNC(name)  _##name##_reorder_weights_opt_268_weight_0_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_268_weight_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_268_weight_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_268_weight_0_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 1,1,256,64,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
#define INPUT0_PITCHES (size_t []){ 1,1,1,256,1,1,1,1,1, } 
#define INPUT0_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 1,1,256,64,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,1,1,256,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_276_weight_0_0
#define KERNEL(name) __kernel void reorder_weights_opt_276_weight_0_0
#define KERNEL_ID reorder_weights_opt_276_weight_0_0
#define FUNC(name)  _##name##_reorder_weights_opt_276_weight_0_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_276_weight_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_276_weight_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_276_weight_0_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 7
#define INPUT0_SIZE_Y 7
#define INPUT0_SIZE_Z 1
#define INPUT0_IFM_NUM 3
#define INPUT0_OFM_NUM 64
#define INPUT0_GROUPS_NUM 1
#define INPUT0_X_PITCH 1
#define INPUT0_Y_PITCH 7
#define INPUT0_Z_PITCH 1
#define INPUT0_IFM_PITCH 49
#define INPUT0_OFM_PITCH 147
#define INPUT0_GROUPS_PITCH 1
#define INPUT0_LENGTH 9408
#define INPUT0_VIEW_OFFSET 0
#define INPUT0_DIMS 4
#define INPUT0_SIMPLE 1
#define INPUT0_GROUPED 0
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 7,7,3,64,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
#define INPUT0_PITCHES (size_t []){ 1,7,49,147,1,1,1,1,1, } 
#define INPUT0_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define INPUT0_PAD_AFTER (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define INPUT0_INDEX_FUNC inline uint FUNC(OIYX)(){return 0;}
#define INIT_INPUT0_INDEX_FUNC_HERE INPUT0_INDEX_FUNC
...
#define OUTPUT_SIZE_Z 1
#define OUTPUT_IFM_NUM 3
#define OUTPUT_OFM_NUM 64
#define OUTPUT_GROUPS_NUM 1
#define OUTPUT_X_PITCH 1
#define OUTPUT_Y_PITCH 7
#define OUTPUT_Z_PITCH 1
#define OUTPUT_IFM_PITCH 49
#define OUTPUT_OFM_PITCH 784
#define OUTPUT_GROUPS_PITCH 1
#define OUTPUT_LENGTH 9408
#define OUTPUT_VIEW_OFFSET 0
#define OUTPUT_DIMS 4
#define OUTPUT_SIMPLE 0
#define OUTPUT_GROUPED 0
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 7,7,3,64,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,7,49,784,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define OUTPUT_PAD_AFTER (size_t []){ 0,0,13,0,0,0,0,0,0, } 
#define OUTPUT_INDEX_FUNC inline uint FUNC(OS_IS_YX_ISV16_OSV16)(){return 0;}
#define INIT_OUTPUT_INDEX_FUNC_HERE OUTPUT_INDEX_FUNC
#define GET_OUTPUT_OS_IS_YX_ISV16_OSV16_INDEX(prefix, g, o, i, z, y, x, sub_group_size)  \
    CAT(prefix, _OFFSET) + \
