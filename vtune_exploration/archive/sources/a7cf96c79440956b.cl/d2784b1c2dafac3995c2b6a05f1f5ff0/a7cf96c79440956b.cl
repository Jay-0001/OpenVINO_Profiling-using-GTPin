...
//====================================================
// Kernel template: convolution_gpu_bfyx_to_bfyx_f16 
// Kernel name: convolution_gpu_bfyx_to_bfyx_f16_4370654348647957117_0_0
#define KERNEL(name) __kernel void convolution_gpu_bfyx_to_bfyx_f16_4370654348647957117_0_0
#define KERNEL_ID convolution_gpu_bfyx_to_bfyx_f16_4370654348647957117_0_0
#define FUNC(name)  _##name##_convolution_gpu_bfyx_to_bfyx_f16_4370654348647957117_0_0
#define FUNC_CALL(name)  _##name##_convolution_gpu_bfyx_to_bfyx_f16_4370654348647957117_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_convolution_gpu_bfyx_to_bfyx_f16_4370654348647957117_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_convolution_gpu_bfyx_to_bfyx_f16_4370654348647957117_0_0
...
#define OUTPUT_SIZE_X 112
#define OUTPUT_SIZE_Y 112
...
#define OUTPUT_LENGTH 802816
#define OUTPUT_X_PITCH 1
#define OUTPUT_Y_PITCH 112
#define OUTPUT_Z_PITCH 1
#define OUTPUT_W_PITCH 1
#define OUTPUT_U_PITCH 1
#define OUTPUT_V_PITCH 1
#define OUTPUT_FEATURE_PITCH 12544
#define OUTPUT_BATCH_PITCH 802816
...
#define OUTPUT_SIZES_DATA { 112,112,64,1,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,112,12544,802816,1,1,1,1,1, } 
...
#define FILTER_SIZE_X 7
#define FILTER_SIZE_Y 7
#define FILTER_SIZE_Z 1
#define FILTER_IFM_NUM 3
#define FILTER_OFM_NUM 64
#define FILTER_GROUPS_NUM 1
#define FILTER_X_PITCH 1
#define FILTER_Y_PITCH 7
#define FILTER_Z_PITCH 1
#define FILTER_IFM_PITCH 49
#define FILTER_OFM_PITCH 784
#define FILTER_GROUPS_PITCH 1
#define FILTER_LENGTH 9408
...
#define PADDING_SIZE_X 3
#define PADDING_SIZE_Y 3
...
#define FUSED_OP_0_OUTPUT_SIZE_X 112
#define FUSED_OP_0_OUTPUT_SIZE_Y 112
...
#define FUSED_OP_0_OUTPUT_FEATURE_NUM 64
...
#define FUSED_OP_0_OUTPUT_LENGTH 802816
#define FUSED_OP_0_OUTPUT_X_PITCH 1
#define FUSED_OP_0_OUTPUT_Y_PITCH 112
...
#define FUSED_OP_0_OUTPUT_FEATURE_PITCH 12544
#define FUSED_OP_0_OUTPUT_BATCH_PITCH 802816
...
#define FUSED_OP_0_OUTPUT_SIZES_DATA { 112,112,64,1,1,1,1,1,1, } 
...
#define FUSED_OP_0_OUTPUT_PITCHES (size_t []){ 1,112,12544,802816,1,1,1,1,1, } 
...
#undef FEATURE_SLICE_SIZE
#endif
#ifdef DT_OUTPUT_BLOCK_WRITEN
#undef DT_OUTPUT_BLOCK_WRITEN
#endif
#ifdef OUTPUT_PACKED_TYPE
#undef OUTPUT_PACKED_TYPE
#endif
#ifdef TO_OUTPUT_PACKED_TYPE
#undef TO_OUTPUT_PACKED_TYPE
#endif
#undef KERNEL
#undef KERNEL_ID
#undef FUNC
...
// Kernel name: convolution_gpu_bfyx_f16_1x1_13143176461841059678_0_0
#define KERNEL(name) __kernel void convolution_gpu_bfyx_f16_1x1_13143176461841059678_0_0
#define KERNEL_ID convolution_gpu_bfyx_f16_1x1_13143176461841059678_0_0
#define FUNC(name)  _##name##_convolution_gpu_bfyx_f16_1x1_13143176461841059678_0_0
#define FUNC_CALL(name)  _##name##_convolution_gpu_bfyx_f16_1x1_13143176461841059678_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_convolution_gpu_bfyx_f16_1x1_13143176461841059678_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_convolution_gpu_bfyx_f16_1x1_13143176461841059678_0_0
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
#define OUTPUT_BATCH_PITCH 115200
#define OUTPUT_GET_INDEX_SAFE(b, f, y, x) GET_DATA_B_FS_YX_FSV16_INDEX_SAFE(OUTPUT, b, f, y, x)
#define OUTPUT_GET_INDEX(b, f, y, x) GET_DATA_B_FS_YX_FSV16_INDEX(OUTPUT, b, f, y, x)
#define OUTPUT_GET_INDEX_RAW(b, f, y, x) GET_DATA_B_FS_YX_FSV16_INDEX(OUTPUT, b, f, y, x)
#define OUTPUT_VIEW_OFFSET 0
...
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,30,900,115200,1,1,1,1,1, } 
...
// Kernel name: convolution_gpu_bfyx_f16_2019073548513401881_0_0
#define KERNEL(name) __kernel void convolution_gpu_bfyx_f16_2019073548513401881_0_0
#define KERNEL_ID convolution_gpu_bfyx_f16_2019073548513401881_0_0
#define FUNC(name)  _##name##_convolution_gpu_bfyx_f16_2019073548513401881_0_0
#define FUNC_CALL(name)  _##name##_convolution_gpu_bfyx_f16_2019073548513401881_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_convolution_gpu_bfyx_f16_2019073548513401881_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_convolution_gpu_bfyx_f16_2019073548513401881_0_0
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 56,56,64,1,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
#define INPUT0_PITCHES (size_t []){ 1,56,3136,200704,1,1,1,1,1, } 
#define INPUT0_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define INPUT0_PAD_AFTER (size_t []){ 0,0,0,0,0,0,0,0,0, } 
...
#define OUTPUT_BATCH_PITCH 215296
#define OUTPUT_GET_INDEX_SAFE(b, f, y, x) GET_DATA_B_FS_YX_FSV16_INDEX_SAFE(OUTPUT, b, f, y, x)
#define OUTPUT_GET_INDEX(b, f, y, x) GET_DATA_B_FS_YX_FSV16_INDEX(OUTPUT, b, f, y, x)
#define OUTPUT_GET_INDEX_RAW(b, f, y, x) GET_DATA_B_FS_YX_FSV16_INDEX(OUTPUT, b, f, y, x)
#define OUTPUT_VIEW_OFFSET 0
...
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,58,3364,215296,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 1,1,0,0,0,0,0,0,0, } 
#define OUTPUT_PAD_AFTER (size_t []){ 1,1,0,0,0,0,0,0,0, } 
#define OPTIONAL_SHAPE_INFO_ARG 
#define OPTIONAL_SHAPE_INFO_TENSOR 
...
#define FILTER_IS_FP 1
#define FILTER_OFFSET 0
#define FILTER_SIZES_DATA { 1,1,64,64,1,1,1,1,1, } 
CONST_ARRAY_DECL(FILTER_SIZES) = FILTER_SIZES_DATA;
#define FILTER_SIZES CONST_ARRAY_REF(FILTER_SIZES)
...
#define FUSED_OP_0_OUTPUT_IS_FP 1
#define FUSED_OP_0_OUTPUT_OFFSET 0
#define FUSED_OP_0_OUTPUT_SIZES_DATA { 56,56,64,1,1,1,1,1,1, } 
CONST_ARRAY_DECL(FUSED_OP_0_OUTPUT_SIZES) = FUSED_OP_0_OUTPUT_SIZES_DATA;
#define FUSED_OP_0_OUTPUT_SIZES CONST_ARRAY_REF(FUSED_OP_0_OUTPUT_SIZES)
#define FUSED_OP_0_OUTPUT_PITCHES (size_t []){ 1,56,3136,200704,1,1,1,1,1, } 
#define FUSED_OP_0_OUTPUT_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define FUSED_OP_0_OUTPUT_PAD_AFTER (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define FUSED_OP0_DECLS 
#define FUSED_OP0_ARGS 
...
//====================================================
// Kernel template: convolution_gpu_bfyx_f16 
// Kernel name: convolution_gpu_bfyx_f16_3056265394892891115_0_0
#define KERNEL(name) __kernel void convolution_gpu_bfyx_f16_3056265394892891115_0_0
#define KERNEL_ID convolution_gpu_bfyx_f16_3056265394892891115_0_0
#define FUNC(name)  _##name##_convolution_gpu_bfyx_f16_3056265394892891115_0_0
#define FUNC_CALL(name)  _##name##_convolution_gpu_bfyx_f16_3056265394892891115_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_convolution_gpu_bfyx_f16_3056265394892891115_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_convolution_gpu_bfyx_f16_3056265394892891115_0_0
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
#define FILTER_IS_FP 1
#define FILTER_OFFSET 0
#define FILTER_SIZES_DATA { 1,1,1024,2048,1,1,1,1,1, } 
CONST_ARRAY_DECL(FILTER_SIZES) = FILTER_SIZES_DATA;
#define FILTER_SIZES CONST_ARRAY_REF(FILTER_SIZES)
...
//====================================================
// Kernel template: convolution_gpu_bfyx_f16 
// Kernel name: convolution_gpu_bfyx_f16_5655598150652728675_0_0
#define KERNEL(name) __kernel void convolution_gpu_bfyx_f16_5655598150652728675_0_0
#define KERNEL_ID convolution_gpu_bfyx_f16_5655598150652728675_0_0
#define FUNC(name)  _##name##_convolution_gpu_bfyx_f16_5655598150652728675_0_0
#define FUNC_CALL(name)  _##name##_convolution_gpu_bfyx_f16_5655598150652728675_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_convolution_gpu_bfyx_f16_5655598150652728675_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_convolution_gpu_bfyx_f16_5655598150652728675_0_0
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
#define INPUT0_BATCH_PITCH 215296
#define INPUT0_GET_INDEX_SAFE(b, f, y, x) GET_DATA_B_FS_YX_FSV16_INDEX_SAFE(INPUT0, b, f, y, x)
#define INPUT0_GET_INDEX(b, f, y, x) GET_DATA_B_FS_YX_FSV16_INDEX(INPUT0, b, f, y, x)
#define INPUT0_GET_INDEX_RAW(b, f, y, x) GET_DATA_B_FS_YX_FSV16_INDEX(INPUT0, b, f, y, x)
#define INPUT0_VIEW_OFFSET 0
...
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
#define INPUT0_PITCHES (size_t []){ 1,58,3364,215296,1,1,1,1,1, } 
...
#define FILTER_OFM_PITCH 576
#define FILTER_GROUPS_PITCH 1
#define FILTER_LENGTH 36864
#define FILTER_VIEW_OFFSET 0
#define FILTER_DIMS 4
#define FILTER_SIMPLE 0
#define FILTER_GROUPED 0
...
#define FILTER_IS_FP 1
#define FILTER_OFFSET 0
#define FILTER_SIZES_DATA { 3,3,64,64,1,1,1,1,1, } 
CONST_ARRAY_DECL(FILTER_SIZES) = FILTER_SIZES_DATA;
#define FILTER_SIZES CONST_ARRAY_REF(FILTER_SIZES)
#define FILTER_PITCHES (size_t []){ 1,3,9,576,1,1,1,1,1, } 
#define FILTER_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define FILTER_PAD_AFTER (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define BIAS_TERM 1
#define BIAS_SIZE_X 1
...
//====================================================
// Kernel template: convolution_gpu_bfyx_f16_1x1 
// Kernel name: convolution_gpu_bfyx_f16_1x1_8638458454580344552_0_0
#define KERNEL(name) __kernel void convolution_gpu_bfyx_f16_1x1_8638458454580344552_0_0
#define KERNEL_ID convolution_gpu_bfyx_f16_1x1_8638458454580344552_0_0
#define FUNC(name)  _##name##_convolution_gpu_bfyx_f16_1x1_8638458454580344552_0_0
#define FUNC_CALL(name)  _##name##_convolution_gpu_bfyx_f16_1x1_8638458454580344552_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_convolution_gpu_bfyx_f16_1x1_8638458454580344552_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_convolution_gpu_bfyx_f16_1x1_8638458454580344552_0_0
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
#define OUTPUT_BATCH_PITCH 65536
#define OUTPUT_GET_INDEX_SAFE(b, f, y, x) GET_DATA_B_FS_YX_FSV16_INDEX_SAFE(OUTPUT, b, f, y, x)
#define OUTPUT_GET_INDEX(b, f, y, x) GET_DATA_B_FS_YX_FSV16_INDEX(OUTPUT, b, f, y, x)
#define OUTPUT_GET_INDEX_RAW(b, f, y, x) GET_DATA_B_FS_YX_FSV16_INDEX(OUTPUT, b, f, y, x)
#define OUTPUT_VIEW_OFFSET 0
...
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,16,256,65536,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 1,1,0,0,0,0,0,0,0, } 
#define OUTPUT_PAD_AFTER (size_t []){ 1,1,0,0,0,0,0,0,0, } 
#define OPTIONAL_SHAPE_INFO_ARG 
#define OPTIONAL_SHAPE_INFO_TENSOR 
...
#define FILTER_IS_FP 1
#define FILTER_OFFSET 0
#define FILTER_SIZES_DATA { 1,1,1024,256,1,1,1,1,1, } 
CONST_ARRAY_DECL(FILTER_SIZES) = FILTER_SIZES_DATA;
#define FILTER_SIZES CONST_ARRAY_REF(FILTER_SIZES)
#define FILTER_PITCHES (size_t []){ 1,1,1,1024,1,1,1,1,1, } 
#define FILTER_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
...
//====================================================
// Kernel template: convolution_gpu_bfyx_f16 
// Kernel name: convolution_gpu_bfyx_f16_13720713998678496926_0_0
#define KERNEL(name) __kernel void convolution_gpu_bfyx_f16_13720713998678496926_0_0
#define KERNEL_ID convolution_gpu_bfyx_f16_13720713998678496926_0_0
#define FUNC(name)  _##name##_convolution_gpu_bfyx_f16_13720713998678496926_0_0
#define FUNC_CALL(name)  _##name##_convolution_gpu_bfyx_f16_13720713998678496926_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_convolution_gpu_bfyx_f16_13720713998678496926_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_convolution_gpu_bfyx_f16_13720713998678496926_0_0
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
#define FILTER_IS_FP 1
#define FILTER_OFFSET 0
#define FILTER_SIZES_DATA { 1,1,256,64,1,1,1,1,1, } 
CONST_ARRAY_DECL(FILTER_SIZES) = FILTER_SIZES_DATA;
#define FILTER_SIZES CONST_ARRAY_REF(FILTER_SIZES)
...
//====================================================
// Kernel template: convolution_gpu_bfyx_f16 
// Kernel name: convolution_gpu_bfyx_f16_8136662051360933988_0_0
#define KERNEL(name) __kernel void convolution_gpu_bfyx_f16_8136662051360933988_0_0
#define KERNEL_ID convolution_gpu_bfyx_f16_8136662051360933988_0_0
#define FUNC(name)  _##name##_convolution_gpu_bfyx_f16_8136662051360933988_0_0
#define FUNC_CALL(name)  _##name##_convolution_gpu_bfyx_f16_8136662051360933988_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_convolution_gpu_bfyx_f16_8136662051360933988_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_convolution_gpu_bfyx_f16_8136662051360933988_0_0
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
...
#define FILTER_IS_FP 1
#define FILTER_OFFSET 0
#define FILTER_SIZES_DATA { 1,1,256,512,1,1,1,1,1, } 
CONST_ARRAY_DECL(FILTER_SIZES) = FILTER_SIZES_DATA;
#define FILTER_SIZES CONST_ARRAY_REF(FILTER_SIZES)
#define FILTER_PITCHES (size_t []){ 1,1,1,256,1,1,1,1,1, } 
#define FILTER_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
