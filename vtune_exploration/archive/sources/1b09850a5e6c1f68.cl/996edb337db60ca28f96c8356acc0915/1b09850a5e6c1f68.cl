...
// Kernel name: convolution_gpu_bfyx_f16_1x1_16212556866347025335_0_0
#define KERNEL(name) __kernel void convolution_gpu_bfyx_f16_1x1_16212556866347025335_0_0
#define KERNEL_ID convolution_gpu_bfyx_f16_1x1_16212556866347025335_0_0
#define FUNC(name)  _##name##_convolution_gpu_bfyx_f16_1x1_16212556866347025335_0_0
#define FUNC_CALL(name)  _##name##_convolution_gpu_bfyx_f16_1x1_16212556866347025335_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_convolution_gpu_bfyx_f16_1x1_16212556866347025335_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_convolution_gpu_bfyx_f16_1x1_16212556866347025335_0_0
...
#define OUTPUT_SIZES_DATA { 56,56,256,1,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,56,3136,802816,1,1,1,1,1, } 
...
#define FILTER_SIZES_DATA { 1,1,64,256,1,1,1,1,1, } 
...
#define FUSED_OP_0_INPUT0_SIZE_X 56
#define FUSED_OP_0_INPUT0_SIZE_Y 56
...
#define FUSED_OP_0_INPUT0_FEATURE_NUM 256
...
#define FUSED_OP_0_INPUT0_LENGTH 802816
#define FUSED_OP_0_INPUT0_X_PITCH 1
#define FUSED_OP_0_INPUT0_Y_PITCH 56
...
#define FUSED_OP_0_INPUT0_FEATURE_PITCH 3136
#define FUSED_OP_0_INPUT0_BATCH_PITCH 802816
...
#define FUSED_OP_0_INPUT0_SIZES_DATA { 56,56,256,1,1,1,1,1,1, } 
...
#define FUSED_OP_0_INPUT0_PITCHES (size_t []){ 1,56,3136,802816,1,1,1,1,1, } 
...
#define FUSED_OP_0_OUTPUT_SIZES_DATA { 56,56,256,1,1,1,1,1,1, } 
...
#define FUSED_OP_0_OUTPUT_PITCHES (size_t []){ 1,56,3136,802816,1,1,1,1,1, } 
...
#define FUSED_OP0_ARGS \
	eltwise0_input0
#define FUSED_OP_1_OUTPUT_SIZE_X 56
#define FUSED_OP_1_OUTPUT_SIZE_Y 56
...
#define FUSED_OP_1_OUTPUT_FEATURE_NUM 256
...
#define FUSED_OP_1_OUTPUT_LENGTH 802816
#define FUSED_OP_1_OUTPUT_X_PITCH 1
#define FUSED_OP_1_OUTPUT_Y_PITCH 56
...
#define FUSED_OP_1_OUTPUT_FEATURE_PITCH 3136
#define FUSED_OP_1_OUTPUT_BATCH_PITCH 802816
...
#define FUSED_OP_1_OUTPUT_SIZES_DATA { 56,56,256,1,1,1,1,1,1, } 
...
#define FUSED_OP_1_OUTPUT_PITCHES (size_t []){ 1,56,3136,802816,1,1,1,1,1, } 
...
//====================================================
// Kernel template: convolution_gpu_bfyx_f16_1x1 
// Kernel name: convolution_gpu_bfyx_f16_1x1_11301203768358881115_0_0
#define KERNEL(name) __kernel void convolution_gpu_bfyx_f16_1x1_11301203768358881115_0_0
#define KERNEL_ID convolution_gpu_bfyx_f16_1x1_11301203768358881115_0_0
#define FUNC(name)  _##name##_convolution_gpu_bfyx_f16_1x1_11301203768358881115_0_0
#define FUNC_CALL(name)  _##name##_convolution_gpu_bfyx_f16_1x1_11301203768358881115_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_convolution_gpu_bfyx_f16_1x1_11301203768358881115_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_convolution_gpu_bfyx_f16_1x1_11301203768358881115_0_0
#define FP64_SUPPORTED 0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INT8_UNIT_USED 0
