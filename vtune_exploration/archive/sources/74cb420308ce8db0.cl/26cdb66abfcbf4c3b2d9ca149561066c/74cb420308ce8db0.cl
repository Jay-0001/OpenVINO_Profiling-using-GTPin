...
// Kernel name: reorder_weights_opt_225_weight_0_0
#define KERNEL(name) __kernel void reorder_weights_opt_225_weight_0_0
#define KERNEL_ID reorder_weights_opt_225_weight_0_0
#define FUNC(name)  _##name##_reorder_weights_opt_225_weight_0_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_225_weight_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_225_weight_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_225_weight_0_0
...
#define INPUT0_OFM_PITCH 4608
#define INPUT0_GROUPS_PITCH 1
#define INPUT0_LENGTH 2359296
...
#define INPUT0_SIZES_DATA { 3,3,512,512,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
#define INPUT0_PITCHES (size_t []){ 1,3,9,4608,1,1,1,1,1, } 
...
#define OUTPUT_SIZES_DATA { 3,3,512,512,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,3,9,4608,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define OUTPUT_PAD_AFTER (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define OUTPUT_INDEX_FUNC inline uint FUNC(OS_IS_YX_ISV16_OSV16)(){return 0;}
#define INIT_OUTPUT_INDEX_FUNC_HERE OUTPUT_INDEX_FUNC
#define GET_OUTPUT_OS_IS_YX_ISV16_OSV16_INDEX(prefix, g, o, i, z, y, x, sub_group_size)  \
    CAT(prefix, _OFFSET) + \
    (g)*CAT(prefix, _GROUPS_PITCH) + \
    ((o) % (sub_group_size)) + \
    (sub_group_size)*( \
...
#define OUTPUT_GET_INDEX(o, i, y, x) GET_OUTPUT_OS_IS_YX_ISV16_OSV16_INDEX(OUTPUT, 0, o, i, 0, y, x, 16)
...
#endif
#ifdef OUTPUT_LAYOUT_OS_IS_YX_ISV16_OSV16
#undef OUTPUT_LAYOUT_OS_IS_YX_ISV16_OSV16
#endif
#ifdef OUTPUT_TYPE
#undef OUTPUT_TYPE
#endif
...
#endif
#ifdef GET_OUTPUT_OS_IS_YX_ISV16_OSV16_INDEX
#undef GET_OUTPUT_OS_IS_YX_ISV16_OSV16_INDEX
#endif
...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_224_weight_0_0
#define KERNEL(name) __kernel void reorder_weights_opt_224_weight_0_0
#define KERNEL_ID reorder_weights_opt_224_weight_0_0
#define FUNC(name)  _##name##_reorder_weights_opt_224_weight_0_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_224_weight_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_224_weight_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_224_weight_0_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 1,1,512,2048,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 1,1,512,2048,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_226_weight_0_0
#define KERNEL(name) __kernel void reorder_weights_opt_226_weight_0_0
#define KERNEL_ID reorder_weights_opt_226_weight_0_0
#define FUNC(name)  _##name##_reorder_weights_opt_226_weight_0_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_226_weight_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_226_weight_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_226_weight_0_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
#define INPUT0_SIZE_Z 1
#define INPUT0_IFM_NUM 2048
#define INPUT0_OFM_NUM 512
#define INPUT0_GROUPS_NUM 1
#define INPUT0_X_PITCH 1
#define INPUT0_Y_PITCH 1
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 1,1,2048,512,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 1,1,2048,512,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_230_weight_0_0
#define KERNEL(name) __kernel void reorder_weights_opt_230_weight_0_0
#define KERNEL_ID reorder_weights_opt_230_weight_0_0
#define FUNC(name)  _##name##_reorder_weights_opt_230_weight_0_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_230_weight_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_230_weight_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_230_weight_0_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
#define INPUT0_SIZE_Z 1
#define INPUT0_IFM_NUM 1024
#define INPUT0_OFM_NUM 2048
#define INPUT0_GROUPS_NUM 1
#define INPUT0_X_PITCH 1
#define INPUT0_Y_PITCH 1
#define INPUT0_Z_PITCH 1
#define INPUT0_IFM_PITCH 1
#define INPUT0_OFM_PITCH 1024
#define INPUT0_GROUPS_PITCH 1
#define INPUT0_LENGTH 2097152
#define INPUT0_VIEW_OFFSET 0
#define INPUT0_DIMS 4
#define INPUT0_SIMPLE 1
#define INPUT0_GROUPED 0
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 1,1,1024,2048,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
#define INPUT0_PITCHES (size_t []){ 1,1,1,1024,1,1,1,1,1, } 
#define INPUT0_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define INPUT0_PAD_AFTER (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define INPUT0_INDEX_FUNC inline uint FUNC(OIYX)(){return 0;}
#define INIT_INPUT0_INDEX_FUNC_HERE INPUT0_INDEX_FUNC
...
#define OUTPUT_Z_PITCH 1
#define OUTPUT_IFM_PITCH 1
#define OUTPUT_OFM_PITCH 1024
#define OUTPUT_GROUPS_PITCH 1
#define OUTPUT_LENGTH 2097152
#define OUTPUT_VIEW_OFFSET 0
#define OUTPUT_DIMS 4
#define OUTPUT_SIMPLE 0
#define OUTPUT_GROUPED 0
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 1,1,1024,2048,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,1,1,1024,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define OUTPUT_PAD_AFTER (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define OUTPUT_INDEX_FUNC inline uint FUNC(OS_IS_YX_ISV16_OSV16)(){return 0;}
#define INIT_OUTPUT_INDEX_FUNC_HERE OUTPUT_INDEX_FUNC
...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_234_weight_0_0
#define KERNEL(name) __kernel void reorder_weights_opt_234_weight_0_0
#define KERNEL_ID reorder_weights_opt_234_weight_0_0
#define FUNC(name)  _##name##_reorder_weights_opt_234_weight_0_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_234_weight_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_234_weight_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_234_weight_0_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
#define INPUT0_SIZE_Z 1
#define INPUT0_IFM_NUM 256
#define INPUT0_OFM_NUM 1024
#define INPUT0_GROUPS_NUM 1
#define INPUT0_X_PITCH 1
#define INPUT0_Y_PITCH 1
#define INPUT0_Z_PITCH 1
#define INPUT0_IFM_PITCH 1
#define INPUT0_OFM_PITCH 256
#define INPUT0_GROUPS_PITCH 1
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 1,1,256,1024,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
...
#define OUTPUT_SIZE_Y 1
#define OUTPUT_SIZE_Z 1
#define OUTPUT_IFM_NUM 256
#define OUTPUT_OFM_NUM 1024
#define OUTPUT_GROUPS_NUM 1
#define OUTPUT_X_PITCH 1
#define OUTPUT_Y_PITCH 1
#define OUTPUT_Z_PITCH 1
#define OUTPUT_IFM_PITCH 1
#define OUTPUT_OFM_PITCH 256
#define OUTPUT_GROUPS_PITCH 1
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 1,1,256,1024,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,1,1,256,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define OUTPUT_PAD_AFTER (size_t []){ 0,0,0,0,0,0,0,0,0, } 
#define OUTPUT_INDEX_FUNC inline uint FUNC(OS_IS_YX_ISV16_OSV16)(){return 0;}
#define INIT_OUTPUT_INDEX_FUNC_HERE OUTPUT_INDEX_FUNC
...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_275_weight_0_0
#define KERNEL(name) __kernel void reorder_weights_opt_275_weight_0_0
#define KERNEL_ID reorder_weights_opt_275_weight_0_0
#define FUNC(name)  _##name##_reorder_weights_opt_275_weight_0_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_275_weight_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_275_weight_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_275_weight_0_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 1,1,64,64,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 1,1,64,64,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_233_weight_0_0
#define KERNEL(name) __kernel void reorder_weights_opt_233_weight_0_0
#define KERNEL_ID reorder_weights_opt_233_weight_0_0
#define FUNC(name)  _##name##_reorder_weights_opt_233_weight_0_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_233_weight_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_233_weight_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_233_weight_0_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 1,1,1024,512,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
#define INPUT0_PITCHES (size_t []){ 1,1,1,1024,1,1,1,1,1, } 
#define INPUT0_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 1,1,1024,512,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,1,1,1024,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
...
//====================================================
// Kernel template: reorder_weights_opt 
// Kernel name: reorder_weights_opt_236_weight_0_0
#define KERNEL(name) __kernel void reorder_weights_opt_236_weight_0_0
#define KERNEL_ID reorder_weights_opt_236_weight_0_0
#define FUNC(name)  _##name##_reorder_weights_opt_236_weight_0_0
#define FUNC_CALL(name)  _##name##_reorder_weights_opt_236_weight_0_0
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_reorder_weights_opt_236_weight_0_0 []
#define CONST_ARRAY_REF(name)  _##name##_reorder_weights_opt_236_weight_0_0
#define FP16_SUPPORTED 1
#define FP16_UNIT_USED 1
#define INPUT0_SIZE_X 1
#define INPUT0_SIZE_Y 1
...
#define INPUT0_IS_FP 1
#define INPUT0_OFFSET 0
#define INPUT0_SIZES_DATA { 1,1,1024,256,1,1,1,1,1, } 
CONST_ARRAY_DECL(INPUT0_SIZES) = INPUT0_SIZES_DATA;
#define INPUT0_SIZES CONST_ARRAY_REF(INPUT0_SIZES)
#define INPUT0_PITCHES (size_t []){ 1,1,1,1024,1,1,1,1,1, } 
#define INPUT0_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
...
#define OUTPUT_IS_FP 1
#define OUTPUT_OFFSET 0
#define OUTPUT_SIZES_DATA { 1,1,1024,256,1,1,1,1,1, } 
CONST_ARRAY_DECL(OUTPUT_SIZES) = OUTPUT_SIZES_DATA;
#define OUTPUT_SIZES CONST_ARRAY_REF(OUTPUT_SIZES)
#define OUTPUT_PITCHES (size_t []){ 1,1,1,1024,1,1,1,1,1, } 
#define OUTPUT_PAD_BEFORE (size_t []){ 0,0,0,0,0,0,0,0,0, } 
